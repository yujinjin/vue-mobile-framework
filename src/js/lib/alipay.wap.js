module.exports = (function() {
	...
	b.pay = function(d, query, $router) {
		...
		// location.href = app.utils.getUrlByRouterReflect("alipay-wap", {goto: c});
		$router.replace({name: "alipay-wap", query: Object.assign({"goto": c}, query || {})});
	};
	b.decode = function(c) {
